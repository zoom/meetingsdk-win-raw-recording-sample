...
public:
	...
	/// \brief Callback to indicate that the list of available languages that interpreters can hear has changed.
	/// \When the list of available languages that interpreters can hear in a meeting is changed, all interpreters in the meeting can get this event.
