...
private:
	...
	bool SendChatMsg(unsigned int receiver, wchar_t* content, ZOOM_SDK_NAMESPACE::SDKChatMessageType msgType);
	ZOOM_SDK_NAMESPACE::SDKChatMessageType ParseChatMsgType();
