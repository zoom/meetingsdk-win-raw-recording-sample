...
void CSDKWithoutLoginStartJoinMeetingFlow::onLoginReturnWithReason(ZOOM_SDK_NAMESPACE::LOGINSTATUS ret, ZOOM_SDK_NAMESPACE::IAccountInfo* pAccountInfo, ZOOM_SDK_NAMESPACE::LoginFailReason reason)
{
	//todo
}
...
void CSDKWithoutLoginStartJoinMeetingFlow::onSuspendParticipantsActivities()
{
	//todo
}