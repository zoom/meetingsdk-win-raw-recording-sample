...
public:
	...
	ZOOM_SDK_NAMESPACE::SDKError DisableEchoCancellation(bool bEnable);
	bool IsEchoCancellationDisabled();
	ZOOM_SDK_NAMESPACE::SDKError EnableHighFidelityMusicMode(bool bEnable);
	bool IsHighFidelityMusicModeDisabled();
