...
ZOOM_SDK_NAMESPACE::SDKError CSDKAudioSettingsWorkFlow::DisableEchoCancellation(bool bEnable)
{
	if(m_pAudioSettingContext)
	{
		ZOOM_SDK_NAMESPACE::SDKError err = ZOOM_SDK_NAMESPACE::SDKERR_SUCCESS;
		err = m_pAudioSettingContext->DisableEchoCancellation(bEnable);
		return err;
	}
	return ZOOM_SDK_NAMESPACE::SDKERR_UNINITIALIZE;
}
bool CSDKAudioSettingsWorkFlow::IsEchoCancellationDisabled()
{
	if(m_pAudioSettingContext)
	{
		bool bChecked = m_pAudioSettingContext->IsEchoCancellationDisabled();
		return bChecked;
	}
	return false;
}

ZOOM_SDK_NAMESPACE::SDKError CSDKAudioSettingsWorkFlow::EnableHighFidelityMusicMode(bool bEnable)
{
	if (m_pAudioSettingContext)
	{
		ZOOM_SDK_NAMESPACE::SDKError err = ZOOM_SDK_NAMESPACE::SDKERR_SUCCESS;
		err = m_pAudioSettingContext->EnableHighFidelityMusicMode(bEnable);
		return err;
	}
	return ZOOM_SDK_NAMESPACE::SDKERR_UNINITIALIZE;
}
bool CSDKAudioSettingsWorkFlow::IsHighFidelityMusicModeDisabled()
{
	if (m_pAudioSettingContext)
	{
		bool bChecked = m_pAudioSettingContext->IsHighFidelityMusicModeDisabled();
		return bChecked;
	}
	return false;
}
