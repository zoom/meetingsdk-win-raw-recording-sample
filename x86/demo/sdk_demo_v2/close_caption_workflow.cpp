...
void CCloseCaptionWorkflow::onClosedCaptionMsgReceived( const wchar_t* ccMsg, unsigned int sender_id, time_t time )
{
	if (m_close_caption_workflow_event)
	{
		m_close_caption_workflow_event->onClosedCaptionMsgReceived(ccMsg, sender_id, time);
	}
}
