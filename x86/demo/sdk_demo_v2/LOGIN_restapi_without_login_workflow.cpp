...
void CSDKRestAPIUserWorkFlow::Cleanup()
{
	m_pMeetingService = NULL;
...
ZOOM_SDK_NAMESPACE::SDKError CSDKRestAPIUserWorkFlow::RestAPIJoinMeeting(ZOOM_SDK_NAMESPACE::JoinParam& joinParam)
{
	ZOOM_SDK_NAMESPACE::SDKError err(ZOOM_SDK_NAMESPACE::SDKERR_SERVICE_FAILED);
	if (IsMeetingServiceReady())
	{
...
void CSDKRestAPIUserWorkFlow::onSuspendParticipantsActivities()
{
	if (NULL != m_pRestAPIUserUIEvent)
		m_pRestAPIUserUIEvent->onSuspendParticipantsActivities();
}
